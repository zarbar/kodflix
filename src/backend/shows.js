module.exports = function shows() {
    return [
...

        {
            ...
            id: 'big-little-lies',
            synopsis: 'The apparently perfect lives of upper-class mothers, at a prestigious elementary school, unravel to the point of murder when a single-mother moves to their quaint Californian beach town.',
        },
        ...
        {
            title: "Naked Director",
            id: 'naked-director',
            synopsis: 'Follows the story of Toru Muranishi\'s unusual and dramatic life filled with big ambitions as well as spectacular setbacks in his attempt to turn Japan\'s porn industry on its head'
        },

        {
            title: "Ru Paul's Drag Race UK",
            id: 'Ru-Paul-UK',
            synopsis: 'RuPaul has come to the UK in search of a queen with the most charisma, uniqueness, nerve and talent.'
        }
    ];
}